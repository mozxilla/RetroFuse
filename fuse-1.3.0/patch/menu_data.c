...
widget_menu_entry widget_menu[] = {
  { "Vega +" },
  { "Favourite2 Game List", INPUT_KEY_NONE, NULL, menu_game_fav, NULL, 0  },
  { "Game List", INPUT_KEY_NONE, NULL, menu_game_list, NULL, 0 },
  { "Game info", INPUT_KEY_NONE, NULL, menu_game_info, NULL , 0 },
  { "Virtual Keyboard", INPUT_KEY_NONE, NULL, menu_virtualkeyboard, NULL, 0 },
  { "Access SD Card Games", INPUT_KEY_NONE, NULL, menu_game_sdcard, NULL, 0 },
  { "Save game state", INPUT_KEY_NONE, NULL, menu_game_save, NULL, 0 },
  { "Load game state", INPUT_KEY_NONE, NULL, menu_game_load, NULL, 0 },
  { "Remap game keys", INPUT_KEY_NONE, NULL, menu_game_remap_keys, NULL, 0},
  { "Apply pokes (if available)", INPUT_KEY_NONE, NULL, menu_game_apply_pokes, NULL, 0 },
  { "Settings", INPUT_KEY_NONE, NULL, menu_game_settings, NULL, 0 },
  { "Hall of Fame", INPUT_KEY_NONE, NULL, menu_hall_of_fame, NULL, 0 },
  { "Switch off", INPUT_KEY_NONE, NULL, menu_game_exit, NULL, 0 },
